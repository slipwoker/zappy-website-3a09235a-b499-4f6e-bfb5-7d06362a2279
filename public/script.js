document.addEventListener('DOMContentLoaded', function () {
  ...
  function getErrorMessage(type, fieldName, extra) {
    ...
    const messages = {
      ...
      minlength: label + ' must be at least ' + extra + ' characters.',
      maxlength: label + ' must not exceed ' + extra + ' characters.'
    };
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "רשף פרויקטים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '3a09235a-b499-4f6e-bfb5-7d06362a2279',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '3a09235a-b499-4f6e-bfb5-7d06362a2279';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to +972527077408 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3a09235a-b499-4f6e-bfb5-7d06362a2279';
